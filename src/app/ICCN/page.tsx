    ...
    <>
      ...
      <main className="w-screen min-h-screen overflow-hidden">
        ...
        <section className="w-screen min-h-screen relative">
          ...
          <span className="absolute bg-[#002060] w-2/3 text-white text-8xl font-bold items-center justify-center text-center flex gap-8 top-1/2 -translate-y-1/2 py-12 min-w-[500px] rounded-r-2xl">
            <Image
              src="/ICCN/icon3.svg"
              alt="ICCNimage4"
              width={80}
